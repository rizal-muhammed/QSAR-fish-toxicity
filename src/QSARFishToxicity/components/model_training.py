...
from QSARFishToxicity.entity import (ModelTrainingConfig, ModelTrainingParams)
...
class ModelTraining:
    ...
    def linear_regression(self, X_train, X_val, y_train, y_val):
        ...
        try:
            ...
            logger.exception(f"""" Exception occured in 'linear_regression' 
                             method of 'ModelTraining' class.Exception message: {str(e)}""")
            raise e
    ...
    def svr(self, X_train, X_val, y_train, y_val):
        ...
        try:
            ...
            logger.exception(f"""" Exception occured in 'svr' 
                             method of 'ModelTraining' class.Exception message: {str(e)}""")
            raise e
    ...
    def random_forest(self, X_train, X_val, y_train, y_val):
        ...
        try:
            ...
            logger.exception(f"""" Exception occured in 'random_forest' 
                             method of 'ModelTraining' class.Exception message: {str(e)}""")
            raise e
    ...
    def train(self, X_train, X_val, y_train, y_val):
        ...
        try:
            ...
            logger.exception(f"""" Exception occured in 'train' 
                             method of 'ModelTraining' class.Exception message: {str(e)}""")
            raise e
    ...
    def return_best_model(self, sorted_result_tuple):
        ...
        try:
            ...
            logger.exception(f"""" Exception occured in 'return_best_model' 
                             method of 'ModelTraining' class.Exception message: {str(e)}""")
            raise e
    ...
    Validation: RMSE: {str(best_result_tuple[2])}, r2_score: {str(best_result_tuple[3])}"""
            ...
            logger.exception(f"""" Exception occured in 'save_best_model_and_corresponding_metrics' 
                             method of 'ModelTraining' class.Exception message: {str(e)}""")
            raise e